...
class TestOpenAIService(unittest.TestCase):
    ...
    def test_fetch_privacy_policy_link_finding(self, mock_session_cls):
        ...
        # verify call args to ensure it fetched the right URL
        # The first call is to base_url, second should be to /data-protection-policy
        # Note: urljoin("https://example.com", "/data-protection-policy") -> "https://example.com/data-protection-policy"
